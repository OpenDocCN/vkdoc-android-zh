...
Hello_World 应用启动屏幕的文本标签常量的八个 XML 标签现在定义在我们的**activity _ main**relative layout XML容器中，应该看起来像图 4-3 中所示的屏幕。
...
最后，我们添加了 AttackPlanet.java类活动子类，以及另一个包含 ImageButton 标签的 LinearLayout。现在，我们已经为 Hello_World 应用建立了一个五屏幕框架，供本书剩余部分使用。
