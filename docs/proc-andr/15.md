...
让我们首先创建一个应用程序的初始版本，它只有绘图的基础和一些初始的 UI 元素，但还没有实际的绘图功能。作为清单 [15-1](#Par11) 的临时占位符，我们显示了一个虚拟形状，我们可以使用 UI 旋转它。
...
![A432415_1_En_15_Fig10_HTML.jpg](A432415_1_En_15_Fig10_HTML.jpg)
