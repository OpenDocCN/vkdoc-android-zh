...
![9781430258308_Fig10-01.jpg](images/9781430258308_Fig10-01.jpg)
...
![9781430258308_Fig10-02.jpg](images/9781430258308_Fig10-02.jpg)
...
![9781430258308_Fig10-03.jpg](images/9781430258308_Fig10-03.jpg)
...
![9781430258308_Fig10-04.jpg](images/9781430258308_Fig10-04.jpg)
...
![9781430258308_Fig10-05.jpg](images/9781430258308_Fig10-05.jpg)
...
![9781430258308_Fig10-06.jpg](images/9781430258308_Fig10-06.jpg)
...
![9781430258308_Fig10-07.jpg](images/9781430258308_Fig10-07.jpg)

[图 10-7](#_Fig7) 。Audacity 的生成菜单

“生成”菜单用于生成基本声波。我们将使用的特定选项是啁啾发生器。点击 Chirp 时，我们会看到如图[图 10-8](#Fig8) 所示的对话框。

![9781430258308_Fig10-08.jpg](images/9781430258308_Fig10-08.jpg)
...
![9781430258308_Fig10-09.jpg](images/9781430258308_Fig10-09.jpg)

[图 10-9](#_Fig9) 。Audacity 效果菜单
...
1.  From the Generate menu, select Chirp. In the Chirp Generator dialog box, generate a Square Waveform with the parameters set as shown in [Figure 10-10](#Fig10).
    ...
    ![9781430258308_Fig10-10.jpg](images/9781430258308_Fig10-10.jpg)

    [图 10-10](#_Fig10) 。跳跃声音效果的方形啁啾声发生器对话框

    产生的声波应该类似于图 10-11 中的声波。

    ![9781430258308_Fig10-11.jpg](images/9781430258308_Fig10-11.jpg)
...
2.  In the Effect Menu, select High Pass Filter to run a high-pass filter over the entire wave with the parameters from [Figure 10-12](#Fig12).
    ...
    ![9781430258308_Fig10-12.jpg](images/9781430258308_Fig10-12.jpg)

    [图 10-12](#_Fig12) 。跳转高通滤波器对话框

3.  Next, we select Amplify from the Effect Menu and amplify the sound wave by -2.8dB, as shown in [Figure 10-13](#Fig13).

    ![9781430258308_Fig10-13.jpg](images/9781430258308_Fig10-13.jpg)
...
6.  Run the Fade Out Filter by selecting Effect ➤ Fade Out; then run Effect ➤ Change Speed with the parameter set to 60\. At this point, your sound wave should resemble the one shown in [Figure 10-14](#Fig14).
    ...
    ![9781430258308_Fig10-14.jpg](images/9781430258308_Fig10-14.jpg)

    [图 10-14](#_Fig14) 。跳跃效应的第一阶段
...
1.  First off, duplicate the sound wave using the Duplicate option from the Edit menu. Audacity should now resemble [Figure 10-15](#Fig15).
    ...
    ![9781430258308_Fig10-15.jpg](images/9781430258308_Fig10-15.jpg)
...
2.  Now use the Time Shift Tool from the Tools toolbar to move the second sound wave over to the right. Drag it over until the selection start time reads 0.025s. The result of this step is shown in [Figure 10-16](#Fig16).
    ...
    ![9781430258308_Fig10-16.jpg](images/9781430258308_Fig10-16.jpg)
...
![9781430258308_Fig10-17.jpg](images/9781430258308_Fig10-17.jpg)
...
声音文件应该放在项目的“资源”文件夹中。使用文件➤导出选项将音频导出到资产/声音下的 jump.ogg 中，如图[图 10-18](#Fig18) 所示。

![9781430258308_Fig10-18.jpg](images/9781430258308_Fig10-18.jpg)

[图 10-18](#_Fig18) 。资产文件夹中的 Ogg 文件
...
我们通过使用 Android NDK 的`AAssetManager`来尝试打开 filename 方法参数中提供的文件，从而开始了`CreateSFX`方法T5。如果文件存在，`AAssetManager_open`将返回一个指向`Asset`的指针。
