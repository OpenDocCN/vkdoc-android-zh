...
![9781430258308_Fig08-01.jpg](images/9781430258308_Fig08-01.jpg)

[图 8-1](#_Fig1) 。缩放立方体

变换的旋转元素围绕对象的原点旋转顶点。如图 8-2 中的[所示。](#Fig2)

![9781430258308_Fig08-02.jpg](images/9781430258308_Fig08-02.jpg)

[图 8-2](#_Fig2) 。旋转对游戏对象的影响

变换矩阵的平移组件负责在 3D 空间中移动对象。[图 8-3](#Fig3) 显示了应用于游戏对象位置的偏移。

![9781430258308_Fig08-03.jpg](images/9781430258308_Fig08-03.jpg)
...
![9781430258308_Fig08-04.jpg](images/9781430258308_Fig08-04.jpg)
...
我们使用`Application::CreateSingletons`中的`RegisterEvent`来注册这些事件，如[清单 8-12](#list12) 所示。
...
一旦我们附加到事件上，我们必须在`HandleEvent` 中观察它们，如[清单 8-17](#list17) 所示。
...
![9781430258308_Fig08-05.jpg](images/9781430258308_Fig08-05.jpg)
...
![9781430258308_Fig08-06.jpg](images/9781430258308_Fig08-06.jpg)

[图 8-6](#_Fig6) 。相机位置到近平面的侧面轮廓
...
![9781430258308_Fig08-07.jpg](images/9781430258308_Fig08-07.jpg)

[图 8-7](#_Fig7) 。创建顶部平截头体平面的第一步

然后我们将这个向量乘以近平面上半部分的高度，它存储在`m_frustumParameters[TOP]`中，如图 8-8 中的[所示。](#Fig8)

![9781430258308_Fig08-08.jpg](images/9781430258308_Fig08-08.jpg)

[图 8-8](#_Fig8) 。相机上方向向量乘以平截头体上半部分的高度

[图 8-9](#Fig9) 显示了下一步，将该矢量添加到`nearCenter`位置。

![9781430258308_Fig08-09.jpg](images/9781430258308_Fig08-09.jpg)
