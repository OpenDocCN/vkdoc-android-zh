...
本章中的例子集中在 Android 为基于文件的数据提供的两个主要方法上。方法 1 可以被认为是“应用嵌入式”模型，它使用与应用打包在一起的原始资源和资产。方法 2 是“Java I/O”方法，它利用几乎著名的 java.io 包来操作文件、数据流等，就像在任何其他操作系统上操作基于 Java 的文件管理一样。
