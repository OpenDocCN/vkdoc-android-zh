...
![images](images/square.jpg) **注意** Python 无法通过 SL4A 的 r3 版本访问每一个 Android API。其他语言如 BeanShell 确实有这种能力，并且将用于查看一些缺失的功能。
...
>>> res.result
{u'extras': {u'SCAN_RESULT': u'http://android-scripting.googlecode.com/files/sl4a_r3.apk',![images](images/U002.jpg)
...
`Result(id=6, result={u'network': {u'altitude': 0, u'provider': u'network', u'longitude':![images](images/U002.jpg)
-84.480000000000004, u'time': 1296595452577L, u'latitude': 31.392499999999998, u'speed':![images](images/U002.jpg)
...
`Result(id=7, result=[{u'locality': u'Milford', u'sub_admin_area': u'Baker', u'admin_area':![images](images/U002.jpg)
u'Georgia', u'feature_name': u'Milford', u'country_code': u'US', u'country_name':![images](images/U002.jpg)
...
MediaRecorder facade 让您可以访问音频和视频录制功能。您必须为输出文件提供有效的路径，否则调用将失败。如果您只是想启动视频捕捉应用程序，请使用`startInteractiveVideoRecording`功能。要开始录音，使用`recorderStartMicrophone`功能。对于录像，使用`recorderCaptureVideo`功能。如果您使用其中任何一个，您必须显式调用`recorderStop`来结束先前开始的记录。
...
Result(id=9, result=[-0.14982382999999999, 8.7306430000000006, 5.4345189999999999],![images](images/U002.jpg)
error=None)
>>> droid.sensorsReadMagnetometer()` `Result(id=10, result=[11.25, -37.6875, 13.3125], error=None)
>>> droid.sensorsReadOrientation()
Result(id=11, result=[-2.7596172332763671, -1.0129913330078124, 0.035179258137941358], ![images](images/U002.jpg)
error=None)`
...
{u'cdma_ecio': -70, u'evdo_dbm': -98, u'cdma_dbm': -97, u'evdo_ecio': -1515,![images](images/U002.jpg)
...
Result(id=24, result=None, error=u'com.googlecode.android_scripting.rpc.RpcError: Argument 1![images](images/U002.jpg)
is not present')`
...
`>>> droid.dialogGetInput(u'My Title', u'My Message')`![images](images/0508.jpg)
...
print ['which'] in ('positive', 'negative', 'neutral')`![images](images/0510.jpg)
...
droid.dialogShow()
response = droid.dialogGetResponse().result`![images](images/0511.jpg)
...
droid.dialogShow()
droid.dialogGetResponse()
ans = droid.dialogGetSelectedItems()`![images](images/0512.jpg)
...
droid.dialogDismiss()`![images](images/0513.jpg)
