...
![Image](images/9781430239451_Fig03-01.jpg)
...
相对布局是唯一允许我们以应用程序需要的方式重叠视图的布局。由于它需要引用布局的其他部分来在屏幕上放置一个视图，你必须确保本书中的所有`RelativeLayout`都准确地复制到你的代码中；否则，你的整个布局看起来会非常混乱，视图会到处都是，除了你放置它们的地方。
...
![Image](images/9781430239451_Fig03-02.jpg)

**图 3-2。** *无 GPS 定位的 app 截图*

![Image](images/9781430239451_Fig03-03.jpg)
...
![Image](images/9781430239451_Fig03-04.jpg)
...
![Image](images/9781430239451_Fig03-05.jpg)
