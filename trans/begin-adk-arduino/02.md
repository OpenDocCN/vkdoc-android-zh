...
![images](images/9781430241973_Fig02-01.jpg)
...
![images](images/9781430241973_Fig02-04.jpg)
...
点击工具![image](images/U001.jpg)板，选择 Arduino Mega 2560(参见[图 2-5](#fig_2_5) )。

![images](images/9781430241973_Fig02-05.jpg)

***图 2-5。** Arduino IDE 板选择*

现在转到工具![image](images/U001.jpg)串行端口并选择你的板连接的端口([图 2-6](#fig_2_6) )。

![images](images/9781430241973_Fig02-06.jpg)
...
![images](images/9781430241973_Fig02-07.jpg)

***图 2-7。** Arduino IDE 串行监视器*

恭喜你！你已经写好了你的第一张 Arduino 草图，并且已经做好了一切准备来开始真正的 ADK 部分。

![images](images/square.jpg) **注意**在撰写本文时，Arduino IDE 的新版本正在发布。1.0 版在内部库和 IDE 用户界面中引入了许多变化。一些与 ADK 相关的库可能还不完全兼容。如果您在编译示例时遇到任何问题，您可能希望确保使用 IDE 的旧版本。本书中的示例是用 Arduino IDE 修订版 0022 编写和编译的。
...
要编写 Android 的“Hello World”等价物，您必须打开 Eclipse IDE。一旦启动，选择`File` ![image](images/U001.jpg) `New` ![image](images/U001.jpg) `Other`(见[图 2-8](#fig_2_8) )。

![images](images/9781430241973_Fig02-08.jpg)

***图 2-8。** Eclipse IDE 新项目创建*

一个新的对话框将会弹出，里面有很多项目类型可供选择。您需要选择`Android Project`，点击`Next`，如图[图 2-9](#fig_2_9) 所示。

![images](images/9781430241973_Fig02-09.jpg)
...
![images](images/9781430241973_Fig02-10.jpg)
...
![images](images/9781430241973_Fig02-13.jpg)
...
![images](images/9781430241973_Fig02-14.jpg)
...
![images](images/9781430241973_Fig02-15.jpg)
...
![images](images/9781430241973_Fig02-16.jpg)
...
![images](images/9781430241973_Fig02-17.jpg)
...
![images](images/9781430241973_Fig02-18.jpg)

***图 2-18。**Android 设备上的 HelloWorld 应用程序接收消息*

![images](images/9781430241973_Fig02-19.jpg)
