...
安装完成后，可以从提示时选择的开始菜单文件夹启动 Windows 下的 Android Studio 在应用文件夹的 OS X 下；而在 Linux 下通过运行。安装目录下的/Android-studio/bin/studio . sh 文件。不管是什么操作系统，你都应该看到 Android Studio 主屏幕，如图[图 1-5](#Fig5) 所示。
